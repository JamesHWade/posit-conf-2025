...
title-slide-attributes:
  ...
  data-background-image: "media/app-in-trash.png"
  data-background-size: "40% auto"
  data-background-position: "85% center"
execute:
  echo: true
  eval: false
---
...
We can now translate our prompts directly into functional Shiny code in seconds using AI tools.
:::
...
:::{.fragment style="color: #ff3b30; font-size: 1.2em; margin-top: 20px;"}
**Time: 2-4+ hours**
:::
:::
